  ...
  - variation_group_name: Action notifications
    variations:
      - variation_code_snippet: |-
        ...
        variation_description: >-
          The in-progress notification displays when something is happening on
          the page, such as a page loading notification as search results are
          found. Use [animated
      ...
      - variation_code_snippet: >-
          ...
          <br /> <!-- Spacing between standard and field level success
      ...
      - variation_code_snippet: >-
          ...
          <br /> <!-- Spacing between standard and field level warning
          notification examples -->
        ...
        variation_description: >-
          The warning notification is for displaying when an operation has run
          as expected, but doesn’t have the expected results, such as a search
          that returned no results.


          This notification can also be used to display additional critical
          information to a user before they submit a form, such as how their
          data will be used and protected or a reminder that they can’t edit
          their responses after submitting.
        variation_implementation: |-
      ...
      - variation_code_snippet: >-
          ...
          <br /> <!-- Spacing between standard and field level error
          notification examples -->
        ...
        variation_description: >-
          The error notification displays when an operation has not run as
